...
var Editable = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var textAreaClassName = computed(function () {
      ...
      return _ref3 = {}, _defineProperty(_ref3, "".concat(props.prefixCls), true), _defineProperty(_ref3, "".concat(props.prefixCls, "-edit-content"), true), _defineProperty(_ref3, "".concat(props.prefixCls, "-rtl"), props.direction === 'rtl'), _defineProperty(_ref3, props.component ? "".concat(props.prefixCls, "-").concat(props.component) : '', true), _ref3;
    });
    return function () {
