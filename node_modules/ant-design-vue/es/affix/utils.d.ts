...
export declare function getFixedTop(placeholderReact: DOMRect, targetRect: DOMRect, offsetTop: number): string;
export declare function getFixedBottom(placeholderReact: DOMRect, targetRect: DOMRect, offsetBottom: number): string;
