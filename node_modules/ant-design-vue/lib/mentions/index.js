...
var Mentions = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      var mergedClassName = (0, _classNames2.default)((_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefixCls.value, "-disabled"), disabled), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls.value, "-focused"), focused.value), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls.value, "-rtl"), direction.value === 'rtl'), _classNames), (0, _statusUtils.getStatusClassNames)(prefixCls.value, mergedStatus.value), !hasFeedback && className);
      ...
      var mentions = (0, _vue.createVNode)(_vcMentions.default, mentionsProps, {
      ...
      if (hasFeedback) {
        return (0, _vue.createVNode)("div", {
          "class": (0, _classNames2.default)("".concat(prefixCls.value, "-affix-wrapper"), (0, _statusUtils.getStatusClassNames)("".concat(prefixCls.value, "-affix-wrapper"), mergedStatus.value, hasFeedback), className)
