...
var _default2 = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    (0, _vue.watchEffect)(function () {
      ...
      (0, _devWarning.default)(!(siderCollapsed.value !== undefined && props.inlineCollapsed === true), 'Menu', '`inlineCollapsed` not control Menu under Sider. Should set `collapsed` on Sider instead.'); // devWarning(
    ...
    (0, _useMenuContext.default)({
      ...
      rootClassName: (0, _vue.computed)(function () {
        return '';
      })
    });
    return function () {
