  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      if ((0, _commonUtils.hasAddon)({
        ...
        var mergedGroupClassName = (0, _classNames3.default)("".concat(prefixCls, "-group-wrapper"), attrs.class, groupClassName); // Need another wrapper for changing display:table to display:inline-block
