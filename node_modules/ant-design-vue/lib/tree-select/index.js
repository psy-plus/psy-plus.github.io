  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      var isFormItemInput = formItemInputContext.isFormItemInput,
          ...
          feedbackIcon = formItemInputContext.feedbackIcon; // ===================== Icons =====================
      ...
      var mergedClassName = (0, _classNames3.default)(!customizePrefixCls && treeSelectPrefixCls.value, (_classNames2 = {}, (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls.value, "-lg"), size.value === 'large'), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls.value, "-sm"), size.value === 'small'), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls.value, "-rtl"), direction.value === 'rtl'), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls.value, "-borderless"), !bordered), (0, _defineProperty2.default)(_classNames2, "".concat(prefixCls.value, "-in-form-item"), isFormItemInput), _classNames2), (0, _statusUtils.getStatusClassNames)(prefixCls.value, mergedStatus.value, hasFeedback), attrs.class);
      var otherProps = {};
