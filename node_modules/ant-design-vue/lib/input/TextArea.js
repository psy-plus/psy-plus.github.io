  ...
  setup: function setup(props, _ref) {
    ...
    var renderTextArea = function renderTextArea() {
      ...
      var resizeProps = (0, _extends2.default)((0, _extends2.default)((0, _extends2.default)({}, (0, _omit.default)(props, ['allowClear'])), attrs), {
        ...
        class: [(_ref2 = {}, (0, _defineProperty2.default)(_ref2, "".concat(prefixCls.value, "-borderless"), !bordered), (0, _defineProperty2.default)(_ref2, "".concat(customClass), customClass && !showCount.value), (0, _defineProperty2.default)(_ref2, "".concat(prefixCls.value, "-sm"), size.value === 'small'), (0, _defineProperty2.default)(_ref2, "".concat(prefixCls.value, "-lg"), size.value === 'large'), _ref2), (0, _statusUtils.getStatusClassNames)(prefixCls.value, mergedStatus.value)],
        showCount: null,
    ...
    (0, _vue.watchEffect)(function () {
      var val = (0, _commonUtils.fixControlledValue)(stateValue.value);
    ...
    return function () {
      ...
      if (showCount.value || formItemInputContext.hasFeedback) {
        ...
        textareaNode = (0, _vue.createVNode)("div", {
          "hidden": hidden,
          "class": (0, _classNames2.default)("".concat(prefixCls.value, "-textarea"), (_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefixCls.value, "-textarea-rtl"), direction.value === 'rtl'), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls.value, "-textarea-show-count"), showCount.value), (0, _defineProperty2.default)(_classNames, "".concat(prefixCls.value, "-textarea-in-form-item"), formItemInputContext.isFormItemInput), _classNames), "".concat(prefixCls.value, "-textarea-show-count"), customClass),
          "style": style,
