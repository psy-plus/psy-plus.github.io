...
var _default2 = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      return (0, _vue.createVNode)(_Input.default, (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, attrs), (0, _omit.default)(rest, ['onUpdate:value', 'onChange', 'onInput'])), {}, {
        ...
        "addonAfter": addonAfter && (0, _vue.createVNode)(_FormItemContext.NoFormStatus, null, {
          default: function _default() {
            return [addonAfter];
          }
        }),
        "addonBefore": addonBefore && (0, _vue.createVNode)(_FormItemContext.NoFormStatus, null, {
          default: function _default() {
            return [addonBefore];
          }
        }),
        "inputClassName": (0, _classNames5.default)((_classNames = {}, (0, _defineProperty2.default)(_classNames, "".concat(prefixClsValue, "-sm"), size.value === 'small'), (0, _defineProperty2.default)(_classNames, "".concat(prefixClsValue, "-lg"), size.value === 'large'), (0, _defineProperty2.default)(_classNames, "".concat(prefixClsValue, "-rtl"), direction.value === 'rtl'), (0, _defineProperty2.default)(_classNames, "".concat(prefixClsValue, "-borderless"), !bordered), _classNames), !inputHasPrefixSuffix && (0, _statusUtils.getStatusClassNames)(prefixClsValue, mergedStatus.value)),
        "affixWrapperClassName": (0, _classNames5.default)((_classNames2 = {}, (0, _defineProperty2.default)(_classNames2, "".concat(prefixClsValue, "-affix-wrapper-sm"), size.value === 'small'), (0, _defineProperty2.default)(_classNames2, "".concat(prefixClsValue, "-affix-wrapper-lg"), size.value === 'large'), (0, _defineProperty2.default)(_classNames2, "".concat(prefixClsValue, "-affix-wrapper-rtl"), direction.value === 'rtl'), (0, _defineProperty2.default)(_classNames2, "".concat(prefixClsValue, "-affix-wrapper-borderless"), !bordered), _classNames2), (0, _statusUtils.getStatusClassNames)("".concat(prefixClsValue, "-affix-wrapper"), mergedStatus.value, hasFeedback)),
        "wrapperClassName": (0, _classNames5.default)((0, _defineProperty2.default)({}, "".concat(prefixClsValue, "-group-rtl"), direction.value === 'rtl')),
        "groupClassName": (0, _classNames5.default)((_classNames4 = {}, (0, _defineProperty2.default)(_classNames4, "".concat(prefixClsValue, "-group-wrapper-sm"), size.value === 'small'), (0, _defineProperty2.default)(_classNames4, "".concat(prefixClsValue, "-group-wrapper-lg"), size.value === 'large'), (0, _defineProperty2.default)(_classNames4, "".concat(prefixClsValue, "-group-wrapper-rtl"), direction.value === 'rtl'), _classNames4), (0, _statusUtils.getStatusClassNames)("".concat(prefixClsValue, "-group-wrapper"), mergedStatus.value, hasFeedback))
