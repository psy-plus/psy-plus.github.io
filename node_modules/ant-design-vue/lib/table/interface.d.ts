...
export declare type FilterSearchType = boolean | ((input: string, record: ColumnFilterItem) => boolean);
...
export interface ColumnType<RecordType = DefaultRecordType> extends Omit<RcColumnType<RecordType>, 'title'> {
