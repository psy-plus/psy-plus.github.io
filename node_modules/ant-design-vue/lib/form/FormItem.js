...
var _default2 = (0, _vue.defineComponent)({
  ...
  setup: function setup(props, _ref) {
    ...
    var formItemInputContext = (0, _vue.reactive)({});
    ...
    (0, _vue.watchEffect)(function () {
      ...
      if (props.hasFeedback) {
        ...
        feedbackIcon = IconNode ? (0, _vue.createVNode)("span", {
          "class": (0, _classNames.default)("".concat(prefixCls.value, "-item-feedback-icon"), "".concat(prefixCls.value, "-item-feedback-icon-").concat(mergedValidateStatus.value))
